...
| Version | Changes |
|---------|---------|
| 2.6 | **RGBW channel rules**: Added Fibaro FGRGBW-442 color channel rules (Red, Green, Blue, White) for both dimmer and voltage endpoints, eliminating all name collisions on RGBW controllers. Confirmation prompt now skips when no changes are pending |
