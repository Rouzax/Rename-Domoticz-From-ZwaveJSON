...
-   :material-download: **[Installation](getting-started/installation.md)**
    ...
    Requirements and the one-time `setup.ps1` run.

-   :material-play: **[Your first run](getting-started/first-run.md)**

    Preview with `-DryRun`, read the report, then apply.

-   :material-tag-text: **[Renaming rules](rules/naming.md)**

    How names are built, and how to change them.

-   :material-help-circle: **[Troubleshooting](troubleshooting.md)**

    Organised by what you saw on screen.
